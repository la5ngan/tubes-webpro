            ...
            <div class="row" style="height: 100%;">
                ...
                <div class="col-lg-10" style="padding: 0px; max-width: 100%;">
                    ...
                    <div style="padding: 100px;">
                        ...
                        <?php echo form_open('HapusObatController/search') ?>
                        ...
                        <table class="table table-bordered table-responsive-md table-striped">
								...
								<tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt-3-half text-center"><?php echo anchor('HapusObatController/hapus/'.$brg['kodeobat'], '<button type="submit" class="btn btn-primary" style="width: 100px; background-color:rgb(33, 179, 33);">Konfirmasi</button>') ?> </td>
									</tr>
                                    <?php endforeach; ?>
								</tbody>
							</table>
